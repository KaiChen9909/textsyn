...
# ==========================================
#SBATCH --job-name=biorxiv_noexample          # 任务名称
...
#SBATCH --output=logs/%j_noexample_stdout.txt    # 标准输出
#SBATCH --error=logs/%j_noexample_stderr.txt     # 错误输出
...
bash scripts/run_biorxiv-condgen_ft_dp.sh 2048 1120 1e-3 29500 4 4.3 512 4 2 biorxiv_noexample
