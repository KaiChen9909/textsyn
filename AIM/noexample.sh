...
#SBATCH --error=logs/%j_noexample_aim_stderr.txt     # 错误输出
...
python main.py --rho 0.18 \
        ...
        --schema_path ../annotation/schema/biorxiv_schema_noexample_test.txt \
        --output_name synthetic_biorxiv_noexample
